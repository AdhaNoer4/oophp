...
$produk1 /* <- ini object*/ = new Produk("Naruto","Masashi kishimoto","Shonen Jump",30000);// dikirim ke constructor
...
// instance class CetakInfoProduk
$infoProduk1 = new CetakInfoProduk();
echo $infoProduk1->cetak($produk1);// cetak produk 1